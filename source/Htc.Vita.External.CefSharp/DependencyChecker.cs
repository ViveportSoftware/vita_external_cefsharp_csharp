...
namespace CefSharp
{
    ...
    public static class DependencyChecker
    {
        ...
        {
            "Htc.Vita.External.CefSharp.Core.dll",
            "Htc.Vita.External.CefSharp.dll"
        };
        ...
        {
            "Htc.Vita.External.CefSharp.BrowserSubprocess.Core.dll",
            "Htc.Vita.External.CefSharp.Core.dll",
            "Htc.Vita.External.CefSharp.dll",
            "icudtl.dat",
            "libcef.dll"
        ...
        public static void AssertAllDependenciesPresent(string locale = null, string localesDirPath = null, string resourcesDirPath = null, bool packLoadingDisabled = false, string browserSubProcessPath = "Htc.Vita.External.CefSharp.BrowserSubProcess.exe")
        {
            string path;
