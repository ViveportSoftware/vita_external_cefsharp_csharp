    ...
    public static class CefExample
    {
        ...
        public static void Init(CefSettingsBase settings, IBrowserProcessHandler browserProcessHandler)
        {
            ...
            if (DebuggingSubProcess)
            {
                ...
                settings.BrowserSubprocessPath = Path.GetFullPath("..\\..\\..\\Htc.Vita.External.CefSharp.BrowserSubprocess\\bin\\" + architecture + "\\Debug\\Htc.Vita.External.CefSharp.BrowserSubprocess.exe");
            }
            ...
            settings.RegisterScheme(new CefCustomScheme
            {
                ...
                SchemeHandlerFactory = new FolderSchemeHandlerFactory(rootFolder: @"..\..\..\..\..\source\Htc.Vita.External.CefSharp.Example\Resources",
